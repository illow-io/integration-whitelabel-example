'use client'
import AreaChartPlot from "./plots/AreaChartPlot";
import BarChartPlot from "./plots/BarChartPlot";
import LineChartPlot from "./plots/LineChartPlot";
import PieChartPlot from "./plots/PieChartPlot";
import RadarChartPlot from "./plots/RadarChartPlot";
